...
mod tests {
    ...
    fn create_test_warning() -> AnalysisError {
        AnalysisError {
            ...
            file_path: PathBuf::from("test.bsl"),
            position: Position { line: 15, column: 3, offset: 150 },
    ...
    fn test_filter_by_file() {
        ...
        assert_eq!(filtered.get_errors()[0].file_path, PathBuf::from("file1.bsl"));
    }
    ...
    fn test_sort_by_location() {
        ...
        let mut error1 = create_test_error();
        error1.position = Position { line: 20, column: 5, offset: 200 };
        
        let mut error2 = create_test_error();
        error2.position = Position { line: 10, column: 3, offset: 100 };
    ...
    fn test_metrics() {
        ...
        assert_eq!(results.metadata().metrics.get("test_metric"), Some(&"test_value".to_string()));
    }
}