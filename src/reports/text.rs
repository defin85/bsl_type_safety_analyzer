...
impl TextReporter {
    ...
    fn format_error_line(
        &self,
        error: &crate::core::AnalysisError,
...
mod winapi {
    pub mod um {
        ...
        pub mod handleapi {
            pub const INVALID_HANDLE_VALUE: *mut std::ffi::c_void =
