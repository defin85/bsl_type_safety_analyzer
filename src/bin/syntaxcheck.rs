...
impl SyntaxCheckCommand {
    ...
    fn print_human_format(
        ...
        for error in errors {
            ...
            writer.write_line(&format!("{}: {}", severity_label, error.message))?;
        ...
        if !self.args.errors_only {
            for warning in warnings {
                ...
                writer.write_line(&format!("{}: {}", severity_label, warning.message))?;
