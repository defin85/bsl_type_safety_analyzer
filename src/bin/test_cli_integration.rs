...
fn main() -> anyhow::Result<()> {
    ...
    if config_path.exists() {
        ...
        println!("⚠️  Конфигурация examples/ConfTest не найдена, пропускаем тест с UnifiedBslIndex");
    ...
    println!("💡 Для полной интеграции нужно обновить main.rs для использования нового BslAnalyzer");
