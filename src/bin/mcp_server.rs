...
use bsl_analyzer::unified_index::{BslApplicationMode, UnifiedBslIndex, UnifiedIndexBuilder};
        ...
        match request.method.as_str() {
            ...
            "tools/call" => {
                ...
                match tool_name {
                    "find_type" => {
                        let type_name =
                            args.get("type_name").and_then(|v| v.as_str()).unwrap_or("");
