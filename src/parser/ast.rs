...
impl AstNode {
    ...
    pub fn is_export(&self) -> bool {
        self.has_attribute("export") || 
        self.get_attribute("export").map_or(false, |v| v == "true")
    }
    
    /// Gets procedure/function name
    pub fn name(&self) -> Option<&str> {
        match self.node_type {
            AstNodeType::Procedure | AstNodeType::Function | AstNodeType::Variable | AstNodeType::Identifier => {
                self.value.as_deref()
            }
            _ => None,
        }
