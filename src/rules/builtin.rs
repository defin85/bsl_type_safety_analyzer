    ...
    pub fn get_all_rules() -> HashMap<String, RuleConfig> {
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Unused variable '{name}'. Consider removing it or prefixing with '_'"
                        .to_string(),
                ),
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Undefined variable '{name}'. Declare it with 'Перем' statement".to_string(),
                ),
                config: Self::create_config(&[
                    ("check_globals", "true"),
                    ("check_builtins", "true"),
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Type mismatch: cannot assign {source_type} to {target_type}".to_string(),
                ),
                config: Self::create_config(&[
                    ("strict_mode", "false"),
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Unknown method '{method}'. Check spelling or documentation".to_string(),
                ),
                config: Self::create_config(&[
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Circular dependency: {module_a} -> {module_b} -> {module_a}".to_string(),
                ),
                config: Self::create_config(&[
                    ("max_depth", "10"),
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Function '{name}' is complex (complexity: {complexity}). Consider refactoring"
                        .to_string(),
                ),
                config: Self::create_config(&[
                    ("max_complexity", "10"),
        ...
        rules.insert(
            ...
            RuleConfig {
                ...
                message: Some(
                    "Public {type} '{name}' should have documentation comment".to_string(),
                ),
                config: Self::create_config(&[
    ...
    pub fn apply_builtin_rules(
            ...
            if let Some(ref error_code) = error.error_code {
                if let Some(rule_config) = rule_configs.get(error_code) {
                    ...
                    if let Some(ref custom_message) = rule_config.message {
                        updated_error.message =
                            Self::format_message(custom_message, &updated_error);
                    }
        ...
        for warning in results.get_warnings() {
            ...
            if let Some(ref error_code) = warning.error_code {
                if let Some(rule_config) = rule_configs.get(error_code) {
                    if let Some(ref custom_message) = rule_config.message {
                        updated_warning.message =
                            Self::format_message(custom_message, &updated_warning);
                    }
